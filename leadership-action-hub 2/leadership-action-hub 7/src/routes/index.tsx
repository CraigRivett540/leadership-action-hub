...
import { LatestNewsPanel } from "@/components/app/latest-news";
  ...
  if (user) {
    return (
      <div className="min-h-screen px-4 py-8 sm:py-10">
        <div className="mx-auto flex w-full max-w-6xl flex-col items-center gap-8 lg:flex-row lg:items-start lg:justify-center lg:gap-10">
